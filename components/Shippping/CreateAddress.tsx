...
const CreateAddress: React.FC<Pops> = ({
  refectShipping,
  refetch,
        ...
        <div className=" ">
          <>
            ...
            >
              ...
              <span className="mr-3 text-customGray text-xl">ثبت آدرس</span>
            </p>
            <div className=" text-customGray rounded-2xl max-md:border-none border-lightGrayBlue2 max-md:py-0 py-6 w-full flex justify-center">
              <div className=" max-md:w-full">
                ...
                <div className="grid grid-cols-2 grid-rows-2 mt-6 gap-x-5">
                  <p className="flex justify-end flex-col">پلاک</p>
                  <p className="flex justify-end flex-col">شماره واحد</p>
                  <Input
                    value={plate}
                    onChange={(e) => {
                      const value = e.target.value;
